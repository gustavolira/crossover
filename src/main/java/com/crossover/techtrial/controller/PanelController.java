...
public class PanelController {
	...
	public ResponseEntity<?> registerPanel(@RequestBody @Valid Panel panel, BindingResult bindingResult) {
	...
	public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
		...
		Panel panel = panelService.findBySerial(panelSerial);
		List<DailyElectricity> dailyElectricityForPanel = hourlyElectricityService.getAllAverageElectricity(panel.getId());
